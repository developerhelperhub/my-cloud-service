                ...
                <Row>
                    <PageTabPanel cols="col-xxl-12 col-lg-12" >
                        ...
                        <PageTabContent id="applicationInfoTabContent">
                            <MonitorInfoTabPage selectedApplication = {this.state.selectedApplication}></MonitorInfoTabPage>
                            <MonitorInstanceTabPage selectedApplication = {this.state.selectedApplication}></MonitorInstanceTabPage>
                        </PageTabContent>
                    </PageTabPanel>
                </Row>
            </PageContent>
